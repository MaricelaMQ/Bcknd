...
$(document).ready(()=> {
    ...
    AjaxReq("php/ciudades.php", {}, "selectCiudad", false, insertOptions);
    AjaxReq("php/tiposVivienda.php", {}, "selectTipo", false, insertOptions);
	...
	$("#submitButton").click((event)=>{
    	event.preventDefault();
      	...
      	AjaxReq("php/buscar.php", {fAply: filtroAply
